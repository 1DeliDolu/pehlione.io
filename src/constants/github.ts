const DEFAULT_GITHUB_USERNAME = '1DeliDolu'

const normalizeUsername = (value: string | undefined) => {
  const trimmed = value?.trim()
  return trimmed ? trimmed : DEFAULT_GITHUB_USERNAME
}

export const githubUsername = normalizeUsername(__GITHUB_USERNAME__)

    ...
    return (
      <section
        ...
        <p className="text-neutral-700 dark:text-neutral-300 mb-6">
          Teamorientiert, motiviert und offen für Neues. Fokus auf saubere
          Umsetzung, klare Kommunikation und kontinuierliche Weiterentwicklung.
        </p>
        ...
        <ul className="list-disc pl-6 mb-6 text-neutral-800 dark:text-neutral-200">
          <li>
            Saubere UI, klare Struktur und nachvollziehbare Entscheidungen
          </li>
